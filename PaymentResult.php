...
/* ── Page body ── */
.body { max-width: 1000px; margin: 0 auto; padding: 30px 40px 80px; }
...
.panel-title {
  font-size: 1rem; font-weight: 700; color: #111; margin-bottom: 22px;
...
.success-badge {
  ...
  background: #f6fff9; border: 1px solid #c3e6cb;
...
.success-text-main { font-size: 1rem; font-weight: 700; color: #155724; }
.success-text-sub  { font-size: 0.8rem; color: #28a745; margin-top: 2px; }
...
.info-row {
  ...
  padding: 10px 0; border-bottom: 1px solid #f5f5f5; font-size: 0.87rem;
}
.info-row:last-child { border-bottom: none; }
.info-label { color: #007bff; font-weight: 600; font-size: 0.78rem; min-width: 120px; }
.info-value { color: #222; font-weight: 600; text-align: right; }

/* ── Section sub-title ── */
.section-label {
  font-size: 0.72rem; font-weight: 700; text-transform: uppercase;
  letter-spacing: 0.08em; color: #bbb; margin-bottom: 12px;
}
...
.products-list::-webkit-scrollbar-track { background: #f8f9fa; border-radius: 4px; }
.products-list::-webkit-scrollbar-thumb { background: #cce0ff; border-radius: 4px; }
...
.product-card:hover { transform: translateY(-3px); box-shadow: 0 8px 16px rgba(0,0,0,0.07); border-color: #007bff; }
...
.product-img img { width: 100%; height: 100%; object-fit: cover; border-radius: 8px; display: block; }

.product-info { flex: 1; }
.product-name { font-size: 0.88rem; font-weight: 600; color: #111; margin-bottom: 3px; }
.product-specs { list-style: none; padding: 0; }
.product-specs li { font-size: 0.73rem; color: #aaa; display: flex; align-items: center; gap: 5px; line-height: 1.65; }
.product-specs li::before { content: ''; width: 4px; height: 4px; border-radius: 50%; background: #007bff; flex-shrink: 0; }
.product-price { font-size: 0.9rem; font-weight: 800; color: #000; white-space: nowrap; align-self: flex-start; padding-top: 2px; }

/* ── Order totals ── */
.order-line { display: flex; justify-content: space-between; align-items: center; font-size: 0.85rem; padding: 5px 0; color: #888; }
.order-line span:last-child { color: #222; font-weight: 600; }
.order-line.free span:last-child { color: #28a745; }
.order-line.total { font-size: 1.05rem; padding: 6px 0; }
.order-line.total span:first-child { color: #111; font-weight: 700; }
.order-line.total span:last-child  { color: #007bff; font-size: 1.2rem; font-weight: 800; }

/* ── Thank you ── */
.thankyou { font-size: 0.85rem; color: #666; line-height: 1.75; }

/* ── Back to Home ── */
.btn-home {
  display: inline-flex; align-items: center; gap: 9px;
  padding: 10px 24px; background-color: #111;
  border: none; border-radius: 8px;
  font-size: 0.9rem; font-weight: 600; color: #fff;
  cursor: pointer; text-decoration: none; transition: 0.3s; margin-top: 20px;
}
.btn-home:hover { background-color: #007bff; }
.btn-home svg { width: 16px; height: 16px; fill: #fff; }

/* ── Responsive ── */
@media (max-width: 540px) {
  .topbar { padding: 0 16px; } .breadcrumb { display: none; }
  .panel { padding: 22px 16px; } .step-line { width: 28px; }
...
<div class="steps-bar">
  ...
  <div class="step done"><div class="step-num">✓</div> Checkout</div>
  <div class="step-line"></div>
  <div class="step active"><div class="step-num">3</div> Confirmation</div>
</div>
...
<div class="body">
  <div class="panel">
    ...
    <div class="info-row" style="border-bottom:none">
      ...
      <span class="info-value" style="color:#1d6fd8;font-size:1rem;font-weight:700"><?= htmlspecialchars($total) ?></span>
    </div>
