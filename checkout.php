        ...
        <div class="panel" style="animation-delay:0.05s">
          ...
          <div class="form-row">
            <div class="field">
              ...
              <input type="text" id="first_name" name="first_name" class="<?= errClass('first_name', $errors) ?>"
                placeholder="John" value="<?= val('first_name', $v) ?>">
              <?php err('first_name', $errors); ?>
            </div>
            <div class="field">
              <label for="last_name">Last Name</label>
              <input type="text" id="last_name" name="last_name" class="<?= errClass('last_name', $errors) ?>"
                placeholder="Doe" value="<?= val('last_name', $v) ?>">
          ...
          <div class="order-items-list">
            <div class="order-item">
              <div class="item-thumb">
                <img src="images/dell-inspiron15.jpg" alt="Dell Inspiron 15"
              ...
              <div class="item-price">RM 3,500<div class="item-qty">×1</div>
              </div>
              <button type="button" class="remove-btn" onclick="askRemove(this, 3500)">✕ Remove</button>
            </div>
            <div class="order-item">
              <div class="item-thumb">
                <img src="images/wireless-mouse.jpg" alt="Wireless Mouse Pro"
              ...
              <div class="item-price">RM 50<div class="item-qty">×1</div>
              </div>
            ...
            <div class="order-item">
              ...
              <div class="item-price">RM 280<div class="item-qty">×1</div>
              </div>
              <button type="button" class="remove-btn" onclick="askRemove(this, 280)">✕ Remove</button>
            </div>
            <div class="order-item">
              <div class="item-thumb">
                <img src="images/monitor.jpg" alt="27 inch IPS Monitor"
                  onerror="this.style.display='none';this.parentNode.textContent='🖥️'">
              </div>
              <div class="item-info">
                <p>27" IPS Monitor</p>
              ...
              <div class="item-price">RM 1,200<div class="item-qty">×1</div>
              </div>
